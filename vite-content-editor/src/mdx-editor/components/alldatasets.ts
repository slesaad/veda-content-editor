import type { DatasetWithContent } from "../../lib/types";
          ...
          compare: {
            ...
            mapLabel: ({ dateFns, datetime, compareDatetime }) =>
              dateFns && datetime && compareDatetime
                ? `${dateFns.format(datetime, "LLL yyyy")} VS ${dateFns.format(
                    compareDatetime,
                    "LLL yyyy"
                  )}`
                : "",
      ...
      layers: [
        {
          ...
          type: "raster",
          description:
            "Estimated total annual CO₂ emissions from fossil fuel combustion (ffCO₂) across all sectors.",
          zoomExtent: [0, 20],
          legend: {
            unit: { label: "tonne CO₂/km²/year" },
            type: "gradient",
        ...
        },
        {
          ...
          type: "raster",
          description:
            "Estimated total annual ffCO₂ emissions from taxi, take-off, and landing up to 3000 ft.",
          zoomExtent: [0, 20],
          legend: {
            unit: { label: "tonne CO₂/km²/year" },
            type: "gradient",
        ...
        },
        {
          ...
          type: "raster",
          description:
            "Estimated total annual ffCO₂ emissions from Residential buildings.",
          zoomExtent: [0, 20],
          legend: {
            unit: { label: "tonne CO₂/km²/year" },
            type: "gradient",
